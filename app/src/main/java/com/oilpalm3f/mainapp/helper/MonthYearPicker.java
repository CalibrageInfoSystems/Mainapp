...
/**
 * Created by siva on 11/05/17.
 */

@SuppressLint("InflateParams")
public class MonthYearPicker  implements NumberPicker.OnValueChangeListener {
    ...
    public void build(int selectedMonth, int selectedYear, DialogInterface.OnClickListener positiveButtonListener,
       ...
       // monthNumberPicker.setOnScrollListener(this);
        ...
        builder.setTitle(currentMonth+"   "+currentYear);
    ...
    if(oldVal==11 && newVal==0 ){
            yearNumberPicker.setValue(yearNumberPicker.getValue()+1);
